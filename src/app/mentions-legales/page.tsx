      ...
      <div className="prose prose-sm max-w-none text-text space-y-6">
        <section>
          ...
          <p className="text-text-secondary leading-relaxed">
            Le site ConfigPC.ch est édité par ConfigPC Sàrl, société à responsabilité limitée de droit suisse,
            inscrite au Registre du commerce du canton de Vaud.<br />
            Siège social : Rue du Lac 12, 1003 Lausanne, Suisse<br />
            Numéro IDE : CHE-000.000.000<br />
        ...
        <section>
          ...
          <p className="text-text-secondary leading-relaxed">
            ...
            exclusive de ConfigPC Sàrl ou de ses partenaires et est protégé par les lois suisses et internationales
        ...
        <section>
          ...
          <p className="text-text-secondary leading-relaxed">
            ...
            Certains de ces liens peuvent être des liens d&apos;affiliation, ce qui signifie que ConfigPC Sàrl peut percevoir
        ...
        <section>
          ...
          <p className="text-text-secondary leading-relaxed">
            ...
            des prix réels pratiqués par les marchands. ConfigPC Sàrl ne saurait être tenu responsable des écarts de prix,
